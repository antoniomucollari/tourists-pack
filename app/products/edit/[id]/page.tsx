    ...
    const fetchProduct = async () => {
      try {
        ...
        if (data.productType === 'PACKET') {
          ...
          // Set the current image URL to display it
    ...
    try {
      ...
      const productData = {
        ...
        ...(productType === 'PACKET' ? {
          ...
          // Pass the existing image URL back
          imageUrl: currentImageUrl || 'https://community.softr.io/uploads/db9110/original/2X/7/74e6e7e382d0ff5d7773ca9a87e6f6f8817a68a6.jpeg'
        })
      };

      // The `updateProduct` function will receive the new image file if it exists,
      // or null if not. The backend should handle this by not updating the image if the file is null.
