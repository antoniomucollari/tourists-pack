      ...
      <div className="border rounded-xl shadow-sm flex flex-col transition-all hover:shadow-lg hover:border-red-300 bg-white h-full">
        ...
        <div className="w-full h-48 bg-gray-100 rounded-t-xl flex items-center justify-center overflow-hidden">
          <img
            src={
              product.imageUrl ||
              "https://placehold.co/400x300/e2e8f0/adb5bd?text=No+Image"
            }
            alt={product.name}
        ...
        <div className="p-4 flex flex-col flex-grow">
          ...
          <div className="mb-4 text-sm text-gray-600 space-y-2">
            ...
            <p
              className={`${
                product.stockNumber > 0 ? "text-green-600" : "text-red-600"
              }`}
            >
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
            ...
            <button
              ...
              className="text-white bg-[#e60000] px-4 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition-colors disabled:bg-gray-400"
