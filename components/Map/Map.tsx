...
export default function Map(props: MapProps){
    useEffect(() => { //the code runs only in the browser after hydration
    ...
    return (
            <MapContainer center={CordinateArr?? [41.32393628568503, 19.789409570999812]} zoom={15} scrollWheelZoom={true} style={{height:'500px'}}>
